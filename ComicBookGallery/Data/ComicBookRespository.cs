        ...
        private static ComicBook[] _comicBooks = new ComicBook[]
        {
            ...
            new ComicBook()
            {
                ...
                DescriptionHtml = "<p><strong>FF: THREE TIE-IN.</strong> Spider-Man visits the FF for " +
                        "a very private wake--just for family.</p>",
                Artists = new Artist[]
                {
                    new Artist() { Name = "Dan Slott", Role = "Script" },
            ...
            new ComicBook()
            {
                ...
                DescriptionHtml = "<p><strong>The Dungeon & The Parapet, Part 1.</strong> Thorn is " +
                        "discovered by Lord Tarsil and the corrupted Stickeaters and thrown into a " +
                        "dungeon with Fone Bone. As she sleeps, a message comes to her about the " +
                        "mysterious \"Crown of Horns\".</p>",
                Artists = new Artist[]
                {
